...
// Create media-queries helpers - to be made available by the Theme.
const themeMediaQueryHelpers = Object.keys(sizes).reduce((acc, label) => {
  acc[label] = (...cssTaggedTemplate) => `
